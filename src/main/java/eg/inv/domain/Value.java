...
public class Value implements Serializable {
    ...
    public Value currencySold(String currencySold) {
    ...
    public Value amountEGP(BigDecimal amountEGP) {
    ...
    public Value amountSold(BigDecimal amountSold) {
    ...
    public Value currencyExchangeRate(BigDecimal currencyExchangeRate) {
