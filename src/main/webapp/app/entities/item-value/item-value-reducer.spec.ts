...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMVALUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITEMVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITEMVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITEMVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITEMVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITEMVALUE actions', async () => {
      const expectedActions = [
        {
