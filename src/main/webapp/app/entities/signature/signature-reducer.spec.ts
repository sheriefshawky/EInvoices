...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './signature.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SIGNATURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SIGNATURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SIGNATURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SIGNATURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SIGNATURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SIGNATURE actions', async () => {
      const expectedActions = [
        {
