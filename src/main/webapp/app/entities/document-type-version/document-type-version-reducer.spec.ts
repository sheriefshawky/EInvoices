...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './document-type-version.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTTYPEVERSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCUMENTTYPEVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCUMENTTYPEVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCUMENTTYPEVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTTYPEVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCUMENTTYPEVERSION actions', async () => {
      const expectedActions = [
        {
