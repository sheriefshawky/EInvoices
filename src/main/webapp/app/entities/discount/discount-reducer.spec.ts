...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './discount.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISCOUNT actions', async () => {
      const expectedActions = [
        {
