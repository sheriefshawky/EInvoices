...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISSUERADDRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ISSUERADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ISSUERADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ISSUERADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ISSUERADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ISSUERADDRESS actions', async () => {
      const expectedActions = [
        {
