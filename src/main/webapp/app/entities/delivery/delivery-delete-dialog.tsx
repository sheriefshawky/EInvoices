...
export const DeliveryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eInvoicesApp.delivery.delete.question">
        <Translate contentKey="eInvoicesApp.delivery.delete.question" interpolate={{ id: deliveryEntity.id }}>
