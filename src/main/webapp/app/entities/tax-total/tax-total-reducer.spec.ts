...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tax-total.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAXTOTAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAXTOTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAXTOTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAXTOTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAXTOTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAXTOTAL actions', async () => {
      const expectedActions = [
        {
