...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VALUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VALUE actions', async () => {
      const expectedActions = [
        {
