...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECEIVERADDRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECEIVERADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECEIVERADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECEIVERADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECEIVERADDRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECEIVERADDRESS actions', async () => {
      const expectedActions = [
        {
