...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './workflow-parameters.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKFLOWPARAMETERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKFLOWPARAMETERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKFLOWPARAMETERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKFLOWPARAMETERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKFLOWPARAMETERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKFLOWPARAMETERS actions', async () => {
      const expectedActions = [
        {
