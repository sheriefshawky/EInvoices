...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAXABLEITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAXABLEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAXABLEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAXABLEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAXABLEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAXABLEITEM actions', async () => {
      const expectedActions = [
        {
